...
def extract_data_from_directory(directory_name, file_basename, num_images, img_size, training = True):
    """
...
def extract_train_data(num_images,img_size):
    return extract_data_from_directory(training_data_directory,"satImage", num_images, img_size,True)
...
def extract_labels(filename, num_images, img_size, unet = False):
    """
